...
<body>
		...
		<p style="text-align:justify;">Deja constancia que el Sr(a) {{ $value->name }},laboro en nuestra empresa como <strong>{{ $value->position }}</strong> desde el {{ \Carbon\Carbon::parse($value->start_date)->format('d/m/Y') }} hasta el {{ date('d/m/Y') }}</p>
